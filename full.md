...
[[中文]](https://github.com/Apricityx/ColorMe/tree/master/./introduction-zh_cn.md) | [English]
...
[![仓库大小](https://img.shields.io/github/repo-size/PFingan-Code/PF-GUGUBot?style=flat-square&label=仓库占用)](https://github.com/LoosePrince/PF-GUGUBot/tree/main/GUGUbot//) 
...
[![仓库大小](https://img.shields.io/github/repo-size/PFingan-Code/PF-MCDR-WebUI?style=flat-square&label=仓库占用)](https://github.com/LoosePrince/PF-MCDR-WebUI/tree/main/src//)
...
- 详细说明见文档: [多服面板合并（主/子服、代理与配对）](https://github.com/LoosePrince/PF-MCDR-WebUI/tree/main/src/docs/多服面板合并.md)
...
- 详细参考: [WebUI 事件系统文档](https://github.com/LoosePrince/PF-MCDR-WebUI/tree/main/src/docs/WebUI事件系统.md)
- 示例代码: [examples/](https://github.com/LoosePrince/PF-MCDR-WebUI/tree/main/src/examples/)（含 [插件网页 + 侧边栏 + 自定义 API](https://github.com/LoosePrince/PF-MCDR-WebUI/tree/main/src/examples/webui_plugin_page_example/)）
